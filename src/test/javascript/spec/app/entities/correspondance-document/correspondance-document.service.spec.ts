...
describe('Service Tests', () => {
    ...
    describe('CorrespondanceDocument Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CorrespondanceDocumentService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/correspondance-documents';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CorrespondanceDocument', () => {
