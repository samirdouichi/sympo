...
import { PartenaireDialogComponent } from '../../../../../../main/webapp/app/entities/partenaire/partenaire-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Partenaire Management Dialog Component', () => {
        let comp: PartenaireDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(PartenaireDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'partenaireListModification', content: 'OK'});
